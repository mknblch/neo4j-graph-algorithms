 ...
 */
public final class LongMaxPriorityQueue implements PrimitiveLongIterable {
    private static final int DEFAULT_CAPACITY = 14;
    private int size = 0;
    private long[] heap;
    private final LongDoubleScatterMap costs;

    public LongMaxPriorityQueue() {
        this(DEFAULT_CAPACITY);
    }

    public LongMaxPriorityQueue(final int initialCapacity) {
        final int heapSize;
